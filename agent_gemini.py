...
async def entrypoint(ctx: agents.JobContext):
    session = AgentSession(
        llm=google.beta.realtime.RealtimeModel(
            ...
            voice="Kore",
            temperature=0.8,
            instructions="You are a helpful assistant with web search and weather checking capabilities. You can find current information on news, sports, and any other topics by using web search. You can also check weather for any city using the weather tool."
